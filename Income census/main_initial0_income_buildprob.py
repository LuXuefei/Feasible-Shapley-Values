...
def build_regression(X_train_array, X_valid_array, y_train, y_valid, random_seed): 
    ...
    if not trained:
        ...
        regression.save_weights('./income_model_deep_{}.ckpt'.format(random_seed))
        ...
        regression.load_weights('./income_model_deep_{}.ckpt'.format(random_seed))
    return regression
...
file = open('AdultIncomeDataStd.pkl','wb')
pickle.dump(X_train, file)
pickle.dump(y_train, file)
pickle.dump(X_valid, file)
pickle.dump(y_valid, file)
pickle.dump(Xraw_mean, file)
pickle.dump(Xraw_std, file)
file.close()